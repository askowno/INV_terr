...
mutate(niaps_ext50 = rowSums(across(c(niaps_ch1:niaps_ch10))/sumrem_sa)) %>%
mutate(niaps_ext70 = rowSums(across(c(niaps_ch4:niaps_ch10))/sumrem_sa)) %>%
mutate(niaps_ext90 = rowSums(across(c(niaps_ch6:niaps_ch10))/sumrem_sa)) %>%
  mutate(D3test = case_when(niaps_ext90 >= 0.9 ~ "CR",
